...
const navigation = {
    ...
    plan_site: [
        { name: 'Création de sites internet', href: '/creation-site-internet-nancy' },
        { name: 'Refonte de site web', href: '/creation-site-internet-nancy/refonte' },
    ...
    social: [
        {
            ...
            icon: (props: any) => (
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="25px" height="25px">
                    <path
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/bryan_parisot/',
            icon: (props: any) => (
...
function Footer() {
    return (
        <footer className='bg-secondary px-8 sm:px-20 pt-10'>
            <CallToActionFooter />
            <div className="mx-auto max-w-7xl px-0 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-20">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <h3 className="font-bold leading-6 text-gray-900 text-xl">Restons connecté</h3>
                        <p className="sm:text-base text-sm leading-6 text-gray-900 pr-4">
                    ...
                    <div className="mt-16 grid grid-cols-3 sm:gap-9 gap-5 xl:col-span-2 xl:mt-0">
                        <div>
                            <h3 className="font-bold leading-6 text-gray-900 text-xl">Contact</h3>
                            <ul role="list" className="mt-6 space-y-4">
                                {navigation.contact.map((item) => (
                                    <li key={item.name}>
                                        <Link href={item.href} className="text-sm leading-6 text-gray-800 hover:text-gray-900">
                                            {item.name}
                                        </Link>
                                    </li>
                                ))}
                        ...
                        <div>
                            <h3 className="font-bold leading-6 text-gray-900 text-xl">Plan du site</h3>
                            <ul role="list" className="mt-6 space-y-4">
                        ...
                        <div>
                            <h3 className="font-bold leading-6 text-gray-900 text-xl ">Legal</h3>
                            <ul role="list" className="mt-6 space-y-4">
                ...
                <div className="mt-16 border-t border-black pt-8 sm:mt-20 lg:mt-24">
                    <p className="text-xs leading-5 text-gray-600">&copy; 2023 tous droits reservé</p>
                </div>
            </div>
        </footer >
    )
