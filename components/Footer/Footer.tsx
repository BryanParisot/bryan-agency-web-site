            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-20">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <h3 className="font-bold leading-6 text-white">Restons connecté</h3>
                        <p className="text-sm leading-6 text-emerald-50 pr-4">
                    ...
                    <div className="mt-16 grid grid-cols-3 gap-9 xl:col-span-2 xl:mt-0">
                        <div>
                            <h3 className="font-bold leading-6 text-white">Contact</h3>
                        ...
                        <div>
                            <h3 className="font-bold leading-6 text-white">Plan du site</h3>
                            <ul role="list" className="mt-6 space-y-4">
                        ...
                        <div>
                            <h3 className="font-bold leading-6 text-white">Legal</h3>
                            <ul role="list" className="mt-6 space-y-4">
