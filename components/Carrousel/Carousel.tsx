...
const Carousel = () => {
    ...
    return (
        <div className='relative mt-12 px-5 sm:px-16 mb-10' >
            <h2 className='text-center sm:text-5xl font-anton tracking-wider font-bold text-gray-950 mb-12 text-2xl'>Découvrez mes <span className='text-primary'>solutions web</span>  sur mesure</h2>
