...
function CallToActionFooter() {
    return (
        <div className='bg-red-800 h-[500px] sm:h-96 rounded-xl flex flex-row justify-center items-center px-5' >
            ...
            <div className='space-y-3 sm:space-y-5 sm:pr-0 md:pr-0 xl:pr-96'>
                <h2 className='text-2xl  md:text-3xl font-bold bg-secondary text-black px-4 py-4 font-anton'>
                ...
                <p className='text-emerald-50 text-lg'>
                    ...
                    <Button className='sm:mt-10 mt-5' variant='black' size='lg'>
                        Contactez-nous
                    </Button>
                </Link>
            </div>
