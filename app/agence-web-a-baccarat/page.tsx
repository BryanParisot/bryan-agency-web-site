...
const page = () => {
    ...
    const contentCards = [
        { title: "Création de sites internet à Baccarat", text: 'En tant que développeur web freelance à Baccarat, je m\'engage à être votre partenaire local pour la conception d\'un site internet unique et performant. Chaque site que je construis est une représentation professionnelle en ligne de votre entreprise, adaptée à vos besoins et à votre identité, offrant une expérience utilisateur exceptionnelle.', icon: logo_creation_site, link: '/creation-site-internet-nancy', bg: 'bg-amber-200', alt: "Icône création de site internet" },
        ...
        <main>
            ...
            <div className="sm:mt-20 sm:mb-20 mt-14 mb-14 px-5 sm:px-16">
                <h2 className="text-center text-2xl sm:text-5xl text-gray-950 font-bold font-anton line tracking-wider" >
                    Création de  <span className="text-primary">sites internet et application</span> sur mesure à Baccarat
                </h2>
            ...
            <div className="bg-black w-full text-white mt-20 py-16 flex flex-col items-center ">
                <h2 className="text-2xl sm:text-5xl font-bold mb-10 text-center font-anton line tracking-wider"> Votre <span className="text-primary font-bold">site internet</span> clé-en-main à Baccarat qui fait la différence</h2>
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap items-center bg-gray-100 py-10 rounded-lg">
                    <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                        ...
                        <h3 className="text-3xl mb-2 font-semibold leading-normal font-anton line tracking-wider">
                            A propos de moi
                        </h3>
            ...
            <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-0 space-y-6 px-5">
                ...
                <p className="text-xl font-semibold" >Optimisez votre visibilité sur Google à Baccarat <Link href="referencement-naturel-seo" className="underline text-primary font-bold">En savoir plus</Link></p>
